...
bangCollision.src='../src/public/images/bang.png';
background.src = "../src/public/images/bg.png ";
gameOverPic.src= '../src/public/images/gameOver.png'
flyAudio.src="../src/public/sounds/wing.mp3";
hitAudio.src='../src/public/sounds/explosion.mp3"'
...
ctx.drawImage(gameOverPic,300,200,canvas.width/4,canvas.height/4);// draw the gameover sign
